...
QUnit.test('Test get URI query.', function (assert) {
  ...
  var res00 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo00 = [uri00];
  ...
  var res01 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo01 = [uri01];
  ...
  var res02 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo02 = [uri02];
  ...
  var res10 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo10 = [uri10];
  ...
  var res11 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo11 = [uri11];
  ...
  var res12 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo12 = [uri12];
  ...
  var res20 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  ...
  var res21 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  ...
  var res22 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  ...
  var res23 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo23 = [
    'result?b=3&c=4&a=0',
    'result?b=3&c=4&a=1',
    'result?b=3&c=4&a=2'
  ...
  var res24 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo24 = ['0', '1', '2'];
  assert.equal(
  ...
  var res30 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo30 = [
  ...
  var res31 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo31 = [
  ...
  var res32 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo32 = [
    'http://x.babymri.org/?53320924',
    'http://x.babymri.org/?53320925',
    'http://x.babymri.org/?53320926'
  ...
  var res40 = decodeKeyValueUri(params.input, params.dwvReplaceMode);
  var theo40 = [
