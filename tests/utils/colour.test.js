...
QUnit.test('Test ybrToRgb.', function (assert) {
  ...
  var rgb01 = ybrToRgb(128, 128, 128);
  ...
  var rgb02 = ybrToRgb(255, 255, 255);
...
QUnit.test('Test cielab to ciexyz.', function (assert) {
  ...
  var xyz00 = cielabToCiexyz(lab00);
  ...
  var xyz01 = cielabToCiexyz(lab01);
...
QUnit.test('Test ciexyz to cielab.', function (assert) {
  ...
  var lab00 = ciexyzToCielab(xyz00);
  ...
  var lab01 = ciexyzToCielab(xyz01);
