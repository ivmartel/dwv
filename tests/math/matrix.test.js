...
QUnit.test('Test Matrix33.', function (assert) {
  var m0 = new getIdentityMat33();
  var m1 = new getIdentityMat33();
...
QUnit.test('Test Matrix33 multiply.', function (assert) {
  ...
  var m11 = new Matrix33([
    2, 3, 4, 5, 6, 7, 8, 9, 10
  ]);
  var m10m11 = m10.multiply(m11);
  var res10 = new Matrix33([
...
QUnit.test('Test Matrix33 asOneAndZeros.', function (assert) {
  ...
  // test #01
  var m01 = new Matrix33([
    3, 2, 1, 100, 99, 98, 5.5, 5.6, 5.4
  ]);
  var theo01 = new Matrix33([
    1, 0, 0, 1, 0, 0, 0, 1, 0
  ]);
...
QUnit.test('Test Matrix33 factories.', function (assert) {
  ...
  // test #01
  var m01 = getMatrixFromName('axial');
  assert.ok(m01.equals(theo00), 'Matrix33 factory axial');

  // test #02
  var m02 = getMatrixFromName('coronal');
  var theo02 = new Matrix33([
    1, 0, 0, 0, 0, 1, 0, -1, 0
  ]);
  assert.ok(m02.equals(theo02), 'Matrix33 factory coronal');

  // test #03
  var m03 = getMatrixFromName('sagittal');
  var theo03 = new Matrix33([
    0, 0, -1, 1, 0, 0, 0, -1, 0
  ]);
  assert.ok(m03.equals(theo03), 'Matrix33 factory sagittal');

  // test #04
  var m04 = getMatrixFromName('godo');
