...
QUnit.test('Test Vector3D crossProduct.', function (assert) {
  ...
  var v0x = new Vector3D(1, 0, 0);
  var v0y = new Vector3D(0, 1, 0);
  var v0my = new Vector3D(0, -1, 0);
  var v0z = new Vector3D(0, 0, 1);
  var v0mz = new Vector3D(0, 0, -1);
