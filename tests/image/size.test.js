...
QUnit.test('Test index to and from offset.', function (assert) {
  ...
  for (var i = 0; i < testData00.length; ++i) {
    var index = new Index(testData00[i].values);
  ...
  var size01 = new Size([5, 4, 3, 2]);
  var index01 = new Index([0, 0, 0, 0]);
  // error: start too big
  assert.throws(function () {
