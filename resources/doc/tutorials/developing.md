...
1.  Check DICOM [conformance](/tutorials/conformance) by loading the test [data](https://github.com/ivmartel/dwv/tree/master/data)
1.  Check [integrations](/tutorials/integrations) by launching dwv in some PACS
...
1.  Check the examples: on class doc or [examples](/tutorials/examples)
1.  Create snapshots
